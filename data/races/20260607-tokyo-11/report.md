...
- **最有力展開**: **β 平均ミドル・好位差し（本線★★★）**（鍵馬: ⑪⑬）。対抗 **γ ハイ・差し追込天国★★（=安田の本質。★当日8Rの差し馬場で格上げ）**、伏線 **α 超スロー・瞬発戦★（前残りせず格下げ）**。
- **展開を分ける一点**: ⑪⑬の先行争い ＋ **当日バイアス＝8R(芝1600)で前崩れ・差し優勢が確定**。前残りシナリオ(α)の比重を下げ、差し勢(◯⑰▲⑯×⑨)を相対強調する。
- **★当日更新（15:12 参考R反映）**: 8R同舞台で逃げ7着・前総崩れ・差し上位独占＝**差し馬場**。γを対抗へ格上げ、αを伏線へ格下げ。◎⑭は中団差しの実績(25安田2着も中団から)で堅持、◯⑰・▲⑯・×⑨が一段浮上。
...
→ **観察結果（★15:12記入）**:
> - **8R 芝1600（同舞台・最重要）**: 勝ち時計1:32.8・**上がり最速34.0（33秒台出ず）**。1着⑨⑨(中団)／3着⑩⑪(後方)＝**中後方の差しが上位独占**。**逃げ①①デスサイズ7着・前③勢6/8着＝前総崩れ**。→ **差し優勢・前崩れ馬場**（高速内前残りではない）。
> - **9R 芝2000 香港JCT（直前・8頭）**: ルメール①①①の逃げ切りだが**8頭の少頭数バイアス**で割引（前のサラスヴァティー②②②は7着失速）。内外・脚質判定には不採用（事前方針どおり）。
> - **総合**: 同舞台8Rが「**前が止まって差しが届く**」を明示＝安田の本質(差し天国)と一致。→ **γを対抗★★へ格上げ／αを伏線★へ格下げ**（§2-2・§2-3）。馬場状態の質は当日発表待ちだが、ペース・脚質傾向は差し方向で確定。
...
|----|-----------|:-----:|--------------|------------------|--------|--------|
| β | 平均ミドル・好位差し | **本線★★★** | ⑪⑬が併走〜⑬が2-3番手で前が締まる（王道） | 逃0 先+1 差+1 追-1 | 14 17 16 6 15 | 11 13 |
| γ | ハイ・差し追込天国 | **対抗★★（★8Rの差し馬場で格上げ）** | ⑪⑬が逃げ争い／⑭がまくり／**当日差し馬場** | 逃-2 先-1 差+1 追+2 | 17 16 9 8 7 6 | 11 13 4 14 |
| α | 超スロー・瞬発戦 | **伏線★（★前残りせず格下げ）** | ⑪⑬とも行き脚なく⑪単騎で緩い（⑬が控える） | 逃+1 先+1 差0 追-2 | 11 14 17 15 | 9 3 7 |
...
### 2-3. 当日修正（★15:12 参考R反映）
> **8R（同舞台芝1600）で前総崩れ・差し上位独占＝差し馬場が確定**（逃げ7着／前6・8着／差し1-3着、上がり最速34.0で33秒台が出ず）。9R(2000)は逃げ切りも少頭数バイアスで不採用。
> **付け替え**: γ ハイ・差し追込天国 を **伏線★→対抗★★** へ格上げ／α 超スロー・瞬発戦 を **対抗★★→伏線★** へ格下げ（前残りが決まっていない）。β は本線★★★維持（差し優勢と整合＝好位差しが抜ける筋）。
> **並びへの反映**: 差し勢の◯⑰・▲⑯・×⑨を一段強調。前残り/先行依存の⑪⑬⑪・①④を割引。◎⑭は「中団から差せる」実績（25安田2着も中団差し）で本命堅持＝差し馬場でも対応可。
> **残る変数**: 馬場状態・クッション値の質（高速⇄タフ）は当日発表待ち。タフなら⑥(パワー牝馬)・⑧⑦(地力差し)がさらに浮く可能性。

## （展開→着順の伝達）

最有力βの段階フローでは、**序盤に⑪⑬④が前を締め（A_early）→中盤で逃げ・先行が脚を使い（A_cruise差）→終盤は余力を残した好位差しが抜ける（A_finish×余力）**。この因果で、好枠から好位を取れA_classが突出する**◎⑭がまっすぐ恩恵を受ける**。γ（安田の本質＝ハイ）が出れば前総崩れで◎は沈み、A_finish最強の**◯⑰と後方の×⑨・⑦が浮上**＝ここが本命の最大リスク。

**★当日更新（15:12）**: 8Rで差し馬場が確定し**γ＝対抗★★へ格上げ**。よって伝達も「βで⑭中心／差し馬場でγ寄りに振れた分、◯⑰・▲⑯のA_finishと×⑨・⑧⑦の追込が一段近づく」へ修正。◎⑭は中団から差せる脚があり差し馬場でも軸として堅持するが、**頭は⑰に詰め寄られる**読み。前残り(α)に賭ける⑪⑬・①の上積みは消す。
...
|----|------|------|-----------|---------|--------|--------|
| ◎ | 7-14 | ガイアフォース | 横山武(継続) | β本線で盤石／**★当日差し馬場でも中団から差せる脚で軸堅持(25安田2着も中団差し)**／γ極端ハイでは頭を⑰に詰め寄られる | ・[A]昨年安田2着(1:32.7)・MCS2着(1:31.3)＝A_class現役マイル最上位<br>・[D]当舞台巧者で東京左回り◎<br>・[E]クリーンな好枠＋テン中庸でA_early十分＝前が止まる展開の本命 | ・[H]休み明け2戦目想定で上積み未知<br>・[E]γ極端高速の差し決着ならA_finishで⑰に譲る（条件付で割引大） |
| ◯ | 8-17 | トロヴァトーレ | ルメール(継続) | **★当日差し馬場で恩恵最大＝◎に最接近**／γ(ハイ・差し決着)で最強／β本線でも終盤台頭／α超スローのみ前不利で割引 | ・[B]東京新聞杯→エプソムC連勝の充実度<br>・[C]東京マイル実証の血統(父レイデオロ)＝A_finish最強格<br>・[K]ルメール継続で東京マイルGI最上位 | ・[E]最外8枠でコーナーロス大＝A_early不利<br>・[I]前年安田で掛かり再発＝折り合い懸念 |
...
| × | 5-9 | ウォーターリヒト | 高杉(継続) | **★当日差し馬場で現実味UP**＝γ(ハイ)の大外一気が決まる土俵に／β でも展開向けば届く／αのみ消し | ・[E]A_finish型の追込＝前総崩れ展開で一発<br>・[D]東京マイル3勝＋安田の差し追込本質に合致 | ・[I]過去ゲート癖＝A_early欠如で展開待ち<br>・[B]前走マイラーズC13着で近走不振 |
| 注 | 4-8 | シャンパンカラー | 岩田康(継続) | **★差し馬場でヒモ格上げ**＝当舞台NHKマイルC馬の追込が活きる土俵／無事出れば一発 | ・[D]2023NHKマイルC馬＝当舞台GI勝ちの絶対的コース実績<br>・[E]差し馬場×外差し脚質が噛む | ・[I]昨年安田で大出遅れの前科＝ゲート最大リスク<br>・[A]近年善戦止まり・6歳 |
